...
// //                   </p>
// //                   <p
// //                     className={`text-xs mt-0.5 ${onlineUsers.includes(user._id) ? "text-emerald-400/80" : "text-white/30"}`}
// //                   >
// //                     {onlineUsers ? "Active now" : "Offline"}
// //                   </p>
// //                 </div>
...
//   // Search filter — searchQuery use karo, input nahi
...
//                   // User select karne pe unseen count clear karo
